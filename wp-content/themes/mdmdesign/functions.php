<?php
/**
 * mdmdesign functions and definitions
 *
 ...
 */
function mdmdesign_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on mdmdesign, use a find and replace
		* to change 'mdmdesign' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'mdmdesign', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'mdmdesign' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'mdmdesign_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'mdmdesign_setup' );
 ...
 */
function mdmdesign_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'mdmdesign_content_width', 640 );
}
add_action( 'after_setup_theme', 'mdmdesign_content_width', 0 );
 ...
 */
function mdmdesign_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'mdmdesign' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'mdmdesign' ),
...
add_action( 'widgets_init', 'mdmdesign_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'mdmdesign_scripts' );
...
/**
 * enqueue custom functions file
 */
require get_template_directory() . '/inc/mdmdesign-custom-functions.php';

/**
 * enqueue custom posttype file
 */
require get_template_directory() . '/inc/function-custom-posttype.php';
